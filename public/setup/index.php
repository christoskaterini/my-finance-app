                ...
                <div id="app-settings" class="step-container">
                    ...
                    <form id="app-form">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6"><label for="mail_encryption" class="form-label">Encryption</label><input type="text" class="form-control" id="mail_encryption" name="mail_encryption" value="ssl, tls, nothing, etc" placeholder="tls, ssl"></div>
