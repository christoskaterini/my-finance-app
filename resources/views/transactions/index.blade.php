...
<style>
    ...
    .transactions-table .col-date { width: 10%; }
    .transactions-table .col-user { width: 15%; }
    .transactions-table .col-store { width: 15%; }
    .transactions-table .col-type { width: 8%; }
    .transactions-table .col-details { width: 25%; }
    .transactions-table .col-amount { width: 12%; }
    .transactions-table .col-actions { width: 10%; }
</style>
@endpush
            ...
            <form action="{{ route('transactions.index') }}" method="GET" class="row g-2 align-items-end">
                ...
                <div class="col-md-auto">
                    <select name="month" id="month-select" class="form-select form-select-sm">
                        ...
                        @for ($m = 1; $m <= 12; $m++)
                            <option value="{{ $m }}" @selected($m == $selectedMonth)>{{ date('F', mktime(0, 0, 0, $m, 10)) }}</option>
                        @endfor
                    </select>
                </div>
